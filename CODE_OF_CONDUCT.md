...
The mda_kit_test *Code of Conduct* sets the rules for the behavior of
every member in the mda_kit_test community so that everyone can
...
mda_kit_test is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make mda_kit_test a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and mda_kit_test is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of mda_kit_test comes from its varied community
...
reported by contacting the project team at 'kelsieking23@vt.edu'. The project team will
