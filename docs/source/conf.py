...
htmlhelp_basename = "mda_kit_testdoc"
...
latex_documents = [
    (master_doc, "mda_kit_test.tex", "mda_kit_test Documentation",
     "mda_kit_test", "manual"),
]
...
man_pages = [
    (master_doc, "mda_kit_test", "mda_kit_test Documentation",
     [author], 1)
]
